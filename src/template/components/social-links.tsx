...
export function GitHub({ size }: SVGProps) {
  return (
    <svg
...
export function X({ size }: SVGProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function LinkedIn({ size }: SVGProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function BlueSky({ size }: SVGProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function SocialLinks() {
  const links = [
    ...
    {
      name: 'BlueSky',
      href: 'https://bsky.app/profile/douglasmoura.dev',
